...
if ( isset($_POST["submit"]) ){
        ...
        //cek data apa berhasil diubah / tdk
       if(ubah($_POST) > 0){
        	echo "
            ...
            <div>
                <div class="img_card">
                    <div class="row justify-content-center">
                        <div class="col-md-6 col-7 content_section">
                            ...
                            <div class="content_box">
                                <div class="content_box_inner">
                                    <div>
                                        <h3>
                                            Perubahan data / status U.A ACADEMY
                                        </h3>

                                        <div class="mt75 row justify-content-center">
                                        <form action="" method="post" enctype="multipart/form-data">
                                        	 <div class="col-10">
                                                <input type="hidden" name="id" placeholder="id" class="form-control" value="<?= $mhs["id"]; ?>">
                                            </div>
                                             <div class="col-10">
                                                <input type="hidden" name="gambarlama" placeholder="gambarlama" class="form-control" 
                                                value="<?= $mhs["gambarlama"]; ?>">
                                            </div>
                                            <div class="col-10">
                                                <input type="text" name="nama" placeholder="nama" class="form-control" required value="<?= $mhs["nama"]; ?>">
                                            </div>
                                            <div class="col-10">
                                                <input type="text" name="umur" placeholder="umur" class="form-control"  value="<?= $mhs["umur"]; ?>">
                                            </div>
                                            <div class="col-10">
                                                <input type="text" name="email" placeholder="email" class="form-control"  value="<?= $mhs["email"]; ?>">
                                            </div>
                                            <div class="col-10">
                        ...
                        <div class="col-md-6 col-5 img_section" style="background-image: url('assets/img/bg/890579.png');">
                            <!--map -->
